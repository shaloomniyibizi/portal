<?php 
 ...
 if(isset($_POST['std_add_now']))
 {
	 ...
	 if($stud_name=="" or $email=="" or $password=="" or $cid=="" or $gender=="" or $regno=="" or $dob=="" or $address=="" or $father=="" or $mather=="" or $contact=="")
	 {
		 echo "<script>alert('please fill form and Add Student');</script>";
	 }
	 else
	 {
		$add_student_done = $ravi->add_student($stud_name,$email,$password,$cid,$regno,$dob,$address,$gender,$father,$mather,$contact);
