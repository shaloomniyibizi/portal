...
if(isset($_POST['add_now'])) {
	...
	else
	{
		...
		if($add_dept_done==true) {
			echo "<script>window.location = 'home.php?ravi=dept-dept';</script>";
		} else { 
		...
		<div class="validation-form">
			...
			<form method="post">
				<div class="col-md-12 form-group1 group-mail">
					...
					<input type="text" placeholder="Enter Depertment Name" required="" name="dept_name">
				</div>
				<div class="col-md-12 form-group button-2">
					<input type="submit" class="btn btn-primary" value="Add department" name="add_now">
