					...
					<div class="login-form">
						<form method="post" action="includes/login.inc.php">
							<select class="form-control" name="type" >
								...
								<option class="select_grade" value='admin'>
									As Admin
								</option>
								<option class="select_grade" value='hod'>
									As H O D
								</option>
								<option class="select_grade" value='teacher'>
									As teacher
								</option>
								<option class="select_grade" value='student'>
									As Student
								</option>
							</select>
		...
		<div class="agile_banner_bottom_grids">
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agilew3_contact">
					<h4>Address</h4>
					<p><?php echo $general_fetch['address']; ?></p>
				</div>
			</div>
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right">
					<h4>Phone</h4>
					<p><?php echo $general_fetch['phone']; ?> <span></span></p>
				</div>
			</div>
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right1">
					<h4>Email</h4>
					<p><a href="mailto:info@example.com"><?php echo $general_fetch['email']; ?></a>
						<span><a href="mailto:info@example.com"></a></span></p>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="clearfix"> </div>
	...
	<div class="container">
		<div class="wthree_footer_grid_left">
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1">
				<h4>About Us</h4>
				<p><?php echo $general_fetch['about']; ?></p>
			</div>
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1">
				<h4>Navigation</h4>
				<ul>
			...
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1 wthree_footer_grid_right1">
				<h4>Contact Us</h4>
				<ul>
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:info@example.com"><?php echo $general_fetch['email']; ?></a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i><?php echo $general_fetch['phone']; ?></li>
					<li><i class="fa fa-fax" aria-hidden="true"></i><?php echo $general_fetch['address']; ?></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>&copy; 2022 - 2022 school portal. All rights reserved | Design by Esther</p>
	</div>
</div>
	<?php } else{ ?>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© <?php echo $general_fetch['website_start']; ?> - 2018 Scholarly. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts.</a> Developed By Esther</p>
	</div>
</div>
	<?php }?>
	<!-- //footer -->
