...
else
{
	...
	$teachere = $ravi->getTeacher($email);
	$teacher = $teachere->fetch_assoc();
				...
				<ul id="menu">
					...
					<li id="menu-academico"><a href="#"><i class="fa fa-users"></i> <span>Result</span> <span class="fa fa-angle-right" style="float: right"></span></a>
						<ul id="menu-academico-sub">
							...
							<li id="menu-academico-boletim"><a href="home.php?ravi=add-result&tid=<?=$teacher['tid'];?>">Add result</a></li>
						</ul>
					</li>
